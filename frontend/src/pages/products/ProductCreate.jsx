// frontend/src/pages/quotations/QuotationCreate.jsx
...
const QuotationCreate = () => {
  ...
  // Fetch available items (products/services) and templates
  useEffect(() => {
  ...
  // Update selected template when it changes
  useEffect(() => {
    const getTemplate = async () => {
      if (selectedTemplate) {
        const found = templates.find((t) => t._id === selectedTemplate);
        if (found) {
          setTemplate(found);
        }
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center">
          ...
          <select
            ...
            className="rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors"
          >
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 transition-colors"
        >
      ...
      {/* Quotation Preview */}
      {showPreview && (
        <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700 mb-6 overflow-auto">
          <QuotationPreview
            quotation={{
              ...formData,
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            {formData.items.map((item, index) => (
              <div
                key={index}
                className="grid grid-cols-1 sm:grid-cols-6 gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg"
              >
